...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Teleport p_Teleport;
        ...
        public static SteamVR_Input_ActionSet_Teleport Teleport
        {
            get
            {
                return SteamVR_Actions.p_Teleport.GetCopy<SteamVR_Input_ActionSet_Teleport>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Teleport = ((SteamVR_Input_ActionSet_Teleport)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Teleport>("/actions/Teleport")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Teleport};
        }
    }
}
